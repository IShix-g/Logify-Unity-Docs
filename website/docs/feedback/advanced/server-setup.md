...
# ⚙️ PHP Server Setup and Operations
...
* **Secret Generator**: Click `Open` to open the generation window, then execute ①**Generate**.
* ②Save the **Shared Secret** value as you'll need it for the next server configuration.
...
## ⚙️ Detailed Server Configuration {#detailed-config}
...
* **[🤖 Discord Integration](../webhook-guides/discord.md)**: How to get Webhook URL
* **[💬 Slack Integration](../webhook-guides/slack.md)**: How to get OAuth token and channel ID
* **[📧 Email Integration](./mail.md)**: Setting recipient/sender addresses
